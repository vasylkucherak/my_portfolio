...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', 5000, '.main-prev-btn', '.main-next-btn');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical', 5000);
...
var accordion = function accordion(triggersSelector) {
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var cloud = this.classList.contains('active-style');
      hideAll();
    ...
    link.addEventListener('click', function (event) {
      ...
      function step(time) {
        ...
        var progress = time - start,
            r = toBlock < 0 ? core_js__WEBPACK_IMPORTED_MODULE_1__["Math"].max(widthTop - progress / speed, widthTop + toBlock) : core_js__WEBPACK_IMPORTED_MODULE_1__["Math"].min(widthTop + progress / speed, widthTop + toBlock);
...
var sliders = function sliders(slides, dir, time, prev, next) {
  var slideIndex = 1,
      paused = false;
  ...
  return regeneratorRuntime.async(function postData$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(fetsh(url, {
            method: "POST",
            body: data
          }));
